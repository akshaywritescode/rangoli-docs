...
description: "OTP Verification component help you to implement otp verification for forgot password or signup"
---

<Frame>
  <img src="/images/otp-verification.png" alt="otp verification" />
</Frame>

[View Live Demo](https://rangoli-components.vercel.app/o/otp-verification){openNewTab}

### Does this depend on any other rangoli components?
Yes, otp verification component depend on Separator, Visit<br />
...
### Component Code
```tsx @app/components/OTPVerification.tsx
