...
description: "Password Input Component helps you to add password input in you form like login & register form"
---

<Frame>
  <img src="/images/password-input.png" alt="password input" />
</Frame>

[View Live Demo](https://rangoli-components.vercel.app/p/password-input){openNewTab}
...
```tsx @app/components/PasswordInput.tsx
