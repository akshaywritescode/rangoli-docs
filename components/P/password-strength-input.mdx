---
title: Password Input with strength
description: "Password Input Component with strength indicator, this component helps user to choose a strong password for his account."
---

<Frame>
  <img src="/images/password-strength-input.png" alt="password input" />
</Frame>

[View Live Demo](https://rangoli-components.vercel.app/p/password-strength-input){openNewTab}

### Does this depend on any other rangoli components?
Yes, Password Strength Input component depend on Password Input Component, Visit<br />
**[Password Input Component Guide](https://docs.rangoliui.me/components/P/password-input)**
...
### Component Code
```tsx @app/components/PasswordStrengthInput.tsx
