...
Yes, Pricing section component depend on Pricing Card & Separator, Visit<br />
**[Pricing Card Component Guide](https://docs.rangoliui.me/components/P/pricing-card)**<br />
...
### Component Code
```tsx @/app/components/PricingSection.tsx
