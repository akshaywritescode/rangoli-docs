...
description: "Testimonial Section is a section to show all you user testimonials in you landing page"
---

<Frame>
  <img src="/images/testimonial-section.png" alt="testimonial section" />
</Frame>

[View Live Demo](https://rangoli-components.vercel.app/t/testimonial-section){openNewTab}

### Does this depend on any other rangoli components?
Yes, Testimonial Section component depend on testimonial card, Visit<br />
**[Testimonial Card Component Guide](https://docs.rangoliui.me/components/t/testimonial-card)**
...
### Component Code
```tsx @app/components/TestimonialSection.tsx
